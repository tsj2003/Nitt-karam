      ...
      <div className="card-modern p-8 mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center group">
            <div className="bg-gradient-to-br from-amber-400 to-orange-500 p-4 rounded-3xl shadow-2xl mr-6 transform group-hover:scale-110 transition-all duration-300">
              <img 
                src="/image.png" 
            ...
            <div>
              <h2 className="text-5xl font-bold text-white tracking-tight mb-2">Your Tasks</h2>
              <p className="text-white/70 text-xl">Manage and organize your daily activities</p>
            </div>
          </div>
